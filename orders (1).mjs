...
// order:<id> -> {
//   id, email, customerName, items, total, creditApplied, amountCharged,
...
export default async (req) => {
  ...
  try {
    ...
    if (req.method === 'POST') {
      ...
      // ---------- Aplicar saldo de puntos (creditBalance) como descuento automático ----------
      ...
      const pointsPerQuetzal = await getPointsPerQuetzal();
